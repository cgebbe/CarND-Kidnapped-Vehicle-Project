...
public:
   ...
   *
   */
    LandmarkObs get_nearest_landmark(LandmarkObs observation, std::vector<LandmarkObs> landmarks);
    double calc_likelihood_of_observation(LandmarkObs observation, LandmarkObs landmark, double std_landmark[2]);
